...
- 🌐 **Полноценное API-тестирование**: Готовая инфраструктура для работы с API, включая логирование и форматирование данных.
- 📡 **Service-объекты для API**: ООП-подход к организации API-тестов с автоматическим логированием в Allure.
- 🔄 **Комбинирование UI и API**: Возможность создавать сценарии, совмещающие API и UI-взаимодействия в одном тесте.
- ⚙️ **CI/CD интеграция**: Готовые пайплайны для GitHub Actions, автоматическая публикация отчетов на GitHub Pages.
- 🔒 **Типизация TypeScript**: Надежность, предсказуемость и автодополнение в вашей IDE.
- 🧱 **Модульная архитектура**: Легко расширяйте и адаптируйте фреймворк под свои нужды.
